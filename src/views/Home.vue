<template>
  <div id="app">
    ...
    <div class="grid grid-rows-4 grid-flow-col gap-6">
      <div class="col">
        <div 
          class="relative flex flex-col min-w-0 rounded break-words border bg-white border-1 border-gray-300 text-gray-900">
          <div class="py-3 px-6 mb-0 bg-gray-200 border-b-1 border-b-1 border-gray-300 text-gray-900">
      ...
      <div class="col">
        <div
        class="relative flex flex-col min-w-0 rounded break-words border bg-white border bg-white border-1 border-gray-300">
